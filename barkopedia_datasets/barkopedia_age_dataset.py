...
class BarkopediaAgeGroupDataset(BarkopediaDataset, AudioDatasetMixin):
    """
    ...
    def get_splits(self) -> Dict[str, 'BarkopediaAgeGroupDataset']:
        ...
        train_dataset = BarkopediaAgeGroupDataset(train_config, split="train")
        ...
        test_dataset = BarkopediaAgeGroupDataset(test_config, split="test")
...
def create_barkopedia_age_dataset(
    cache_dir: str = "./barkopedia_dataset",
    hf_token: Optional[str] = None,
    augmentation: bool = False,
    sampling_rate: int = 16000
) -> Dict[str, BarkopediaAgeGroupDataset]:
    """
    ...
    dataset = BarkopediaAgeGroupDataset(config)
...
if __name__ == "__main__":
    """Test the Barkopedia age group dataset implementation."""
    
    print("=== Testing Barkopedia Age Group Dataset ===\n")
    ...
    splits = create_barkopedia_age_dataset(
        hf_token=hf_token,
